class ServiceFactory:
    ...
    Attributes:
        __builders (dict):
            Um dicionario que registrará o nome do projeto como chave e seu serviçõe de conexão como
            valor
    ...
    def create(self, project_name, **kwargs) -> object:
        """
        ...
        Returns:
            object:
                Uma instância de conexão criada pelo builder associado ao projeto.
